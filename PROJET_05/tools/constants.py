...
EMPTY_CATEGORY_TABLE_UI  = "Category table is empty..."
EMPTY_PRODUCT_TABLE_UI 	 = "Product table is empty..."
EMPTY_FAVORITE_TABLE_UI	 = "Favorite table is empty..."
...
EMPTY_FAVORITE_TABLE_MSG = MAGENTA + "\n Favorite table is empty..."
...
EXCEED_DB_PRODUCT_ID 	 = RED + " The number you have chosen exceeds the number of products in the database..."
LOADING_DB_MSG           = GREEN + "\n Database loading... Please wait..."
ALREADY_IN_FAVORITES_MSG = YELLOW + " This product is already in favorites."